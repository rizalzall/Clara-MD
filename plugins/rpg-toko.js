                    ...
                    case 'batu':
                        ...
                        case 'coal':
                           if (global.db.data.users[m.sender].money >= Bcoal * count) {
                               ...
                               conn.reply(m.chat, `✔️ Sukses Membeli ${count} Coal Dengan Harga ${Bcoal * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'umpan':
                ...
                switch (_type) {
                    ...
                    case 'batu':
                        ...
                        if (global.db.data.users[m.sender].coal >= count * 1) {
                            ...
                            global.db.data.users[m.sender].coal -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${count} Coal Dengan Harga ${Scoal * count} Money 💹`.trim(), m)
